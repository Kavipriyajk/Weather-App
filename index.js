...
//We should prevent the default one when someone clicks on search button 
...
//async - performs the function serially 
const getWeather=async (city)=>
{
   
    try{

        const response= await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=dae7ddefac3881287080e59935b80ad0`,
        ...
        {
            tempicon.src="./icons/weathericon.png"
        }
        ...
        .then (data =>
            {
                    ...
                    loc.textContent=name;
                    climate.textContent=main;
                    tempvalue.textContent=Math.round(feels_like-273)-5;
                    if(id<300 && id>200)
                    {
